...
synthimage/corruption/robustness_suite.py::CONDITIONS (frozen, unchanged). No new image files -- transforms are applied
on-the-fly from the original clean paths by synthimage.data.loading::load(), exactly as the existing
n=10 robustness pilot manifest already does at smaller scale."""
from __future__ import annotations
import hashlib
from pathlib import Path
import pandas as pd
from synthimage.corruption.robustness_suite import CONDITIONS, condition_id
