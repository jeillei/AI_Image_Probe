"""Extend data/content_matched/manifest.csv with the 60 pixart_dit rows (genuine PixArt-Sigma DiT), reusing
...
for r in real.itertuples():
    p = Path("data/content_matched/pixart_dit") / f"{r.content_id}.png"
    if not p.exists():
        continue
