...
blockers -- see PREREGISTRATION_pixart_v1.md) counterparts for the 60 existing caption-matched COCO content ids.
...
def main():
    ap = argparse.ArgumentParser(); ap.add_argument("--out", default="data/caption_matched/sdxl"); ap.add_argument("--limit", type=int)
